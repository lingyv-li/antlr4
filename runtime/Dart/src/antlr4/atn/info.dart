...
import 'ProfilingATNSimulator.dart';
...
class DecisionEventInfo {
  ...
  DecisionEventInfo(this.decision,
      this.configs,
      this.input, this.startIndex, this.stopIndex,
      this.fullCtx);
}
 ...
 class AmbiguityInfo extends DecisionEventInfo {
   ...
   */
   AmbiguityInfo(int decision,
      ...
      BitArray this.ambigAlts,
      TokenStream input, int startIndex, int stopIndex,
      bool fullCtx): super(decision, configs, input, startIndex, stopIndex, fullCtx);
}
   ...
   */
   PredicateEvalInfo(int decision,
      ...
      this.semctx,
       this.evalResult,
       this.predictedAlt,
      bool fullCtx):super(decision, new ATNConfigSet(), input, startIndex, stopIndex, fullCtx);
}
