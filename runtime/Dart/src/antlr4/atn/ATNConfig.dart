...
class ATNConfig {
  ...
  var context;
  var semanticContext;
  var reachesIntoOuterContext;
  var precedenceFilterSuppressed;
  ATNConfig(params, config) {
  ...
  updateHashCode(hash) {
    hash.update(
        this.state.stateNumber, this.alt, this.context, this.semanticContext);
  }
...
class LexerATNConfig extends ATNConfig {
  ...
  var passedThroughNonGreedyDecision;
  LexerATNConfig(params, config) : super(params, config) {
    // This is the backing field for {@link //getLexerActionExecutor}.
    var lexerActionExecutor = params.lexerActionExecutor || null;
    this.lexerActionExecutor = lexerActionExecutor ||
        (config != null ? config.lexerActionExecutor : null);
    this.passedThroughNonGreedyDecision = config != null
        ? this.checkNonGreedyDecision(config, this.state)
        : false;
  }
  ...
  hashCodeForConfigSet() => hashCode();
  equalsForConfigSet(other) => equals(other);
