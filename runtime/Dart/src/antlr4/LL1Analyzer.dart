...
//		System.out.println("LOOK("+s.stateNumber+")");
    ...
    for (int alt = 0; alt < s.getNumberOfTransitions(); alt++) {
      ...
      _LOOK(s.transition(alt).target, null, PredictionContext.EMPTY, look[alt],
          lookBusy, new BitArray(), seeThruPreds, false);
  ...
  IntervalSet LOOK(ATNState s, RuleContext ctx, [ATNState stopState = null]) {
    ...
    _LOOK(s, stopState, lookContext, r, Set(), new BitArray(), seeThruPreds,
        true);
    return r;
  }
   ...
   * {@code new BitArray()} for this argument.
...
//					    System.out.println("popping back to "+retState);
          ...
          if (removed) {
            calledRuleStack.setBit(s.ruleIndex);
          }
        }
        return;
      }
    ...
    for (int i = 0; i < n; i++) {
      ...
      if (t is RuleTransition) {
        ...
        try {
          calledRuleStack.setBit(t.target.ruleIndex);
