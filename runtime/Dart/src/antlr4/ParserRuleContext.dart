...
// /
  ...
  getTypedRuleContext(Type ctxType, i) {
    return this.getChild(i, type: ctxType);
  }

  getTypedRuleContexts(Type ctxType) {
    if (this.children == null) {
      return [];
    } else {
      var contexts = [];
  ...
  static final EMPTY = ParserRuleContext(null, 0);
}
